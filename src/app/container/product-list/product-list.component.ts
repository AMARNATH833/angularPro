...
export class ProductListComponent {
  ...
  totalProductInStock = this.products.filter(pr => pr.is_in_inventory == true).length;
  totalProductOutofStock = this.products.filter(pr => pr.is_in_inventory == false).length;
